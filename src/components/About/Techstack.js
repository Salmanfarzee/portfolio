...
import ReactBootstrap from "../../Assets/TechIcons/React Bootstrap.svg";
import Gatsby from "../../Assets/TechIcons/Gatsby.svg";
  ...
  return (
    <Row style={{ justifyContent: "center", paddingBottom: "50px" }}>
      ...
      {/* <Col xs={4} md={2} className="tech-icons">
       ...
       <Col xs={4} md={2} className="tech-icons" >
        <img src={HTML} alt="git" style={{height: "24px",width: "24px"}}/>
        <div className="tech-icons-text">HTML</div>
      </Col> <Col xs={4} md={2} className="tech-icons">
        <img src={CSS} alt="git" style={{height: "24px",width: "24px"}}/>
        <div className="tech-icons-text">CSS</div>
      </Col> <Col xs={4} md={2} className="tech-icons">
        <img src={Bootstrap} alt="git" style={{height: "24px",width: "24px"}}/>
        <div className="tech-icons-text">Bootstrap</div>
      </Col> <Col xs={4} md={2} className="tech-icons">
        <img src={ReactBootstrap} alt="git" style={{height: "24px",width: "24px"}}/>
        <div className="tech-icons-text">React-Bootstrap</div>
      </Col> <Col xs={4} md={2} className="tech-icons">
        <img src={Gatsby} alt="git" style={{height: "24px",width: "24px"}}/>
        <div className="tech-icons-text">Gatsby.js</div>
      </Col>
    </Row>
  );
}
